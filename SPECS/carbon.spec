...
install -d -m 0755 %{buildroot}%{_localstatedir}/log/carbon/carbon-cache
install -d -m 0755 %{buildroot}%{_localstatedir}/run/carbon

mv %{buildroot}%{_prefix}/conf %{buildroot}%{_sysconfdir}/carbon
install -m 0644 %{SOURCE4} %{buildroot}%{_sysconfdir}/carbon/carbon.conf
install -m 0644 %{SOURCE5} %{buildroot}%{_sysconfdir}/carbon/storage-schemas.conf
...
install -m 0644 %{SOURCE6} %{buildroot}%{_sysconfdir}/logrotate.d/carbon
